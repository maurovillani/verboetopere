                        ...
                        <div class="p-1">
                            <div class="btn-toolbar justify-content-end" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="btn-group" role="group" aria-label="First group">
                                    ...
                                    <a><button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#NuovoStudente_Modal">Nuovo</button></a>
                                    &nbsp;&nbsp;
...
//                                    echo anchor(site_url('backend/studenti_ricerca/1'), '<button type="button" class="btn btn-primary">Torna ad elenco filtrato</button>');
                                    echo anchor(site_url('backend/studenti_ricerca/1'), '<button type="button" class="btn btn-secondary">Torna ad elenco filtrato</button>');
                                    ?>
                            </div>
                        </div>
                    </div>
