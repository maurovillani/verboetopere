...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-3 mb-2 mt-2">
            ...
            <?php
            echo anchor(site_url('backend/modulo_iscrizione_corsi/'.$MATRICOLA.'/'.$corsolaurea.'/'.$semestre.'/'.$annoaccademico.'/'.$semestrecorso), '<button type="button" class="btn btn-primary">Stampa modulo</button>');
            ?>
        </div>
    </div>
    <div class="row">
    ...
    <table class="table table-hover" id='corsilist'>
        <thead>
            <tr>
                ...
                <th width="34%" scope="col" colspan="2">Corso</th>
                <!--<th width="27%" scope="col">Titolo</th>-->
                <th width="6%" scope="col">
                    <?php if ($corsolaurea==='210') echo "Tipo";?>
                    <?php if ($corsolaurea!=='210') echo "Scelta";?>
                </th>
            </tr>
        </thead>
        <tbody>
...
<!--    <div class="row">
    ...
    <table class="table table-hover" id='corsilist'>
        <thead>
            <tr>
                <th width="10%" scope="col">Professore</th>
                <th width="34%" scope="col" colspan="2">Seminario</th>
                <!--<th width="27%" scope="col">Titolo</th>-->
                <th width="6%" scope="col">Tipo</th>
            </tr>
        </thead>
        <tbody>
    <?php
