        ...
        <div class="col-lg-6 mb-2 mt-2">
            <div class="row">
                <div class="col-lg-9 mb-2">
                    <label for="COLLEGIO">Nome Collegio
                        <?php if(isset($tab_studente['COLLEGIO'])):?>
                        <a href="<?php echo site_url('backend/collegio/'.$tab_studente['COLLEGIO']); ?>" target="_blank" title="visualizza"> <i class="fas fa-search"></i></i> </a>
                        <?php endif;?>
                    </label>
                    <div class="ui-widget">
