        ...
        <div class="col-lg-6 mb-2 mt-2">
            <div class="row">
                <div class="col-lg-6 mb-2">
                    <label for="NASCDATA">
                        <font <?php if ($tab_studente['NASCDATA']=='') echo "color='red'";?>>
                        Data di nascita *
                        </font>
                    </label>
                ...
                <div class="col-lg-6 mb-2">
                    <label for="NASCCOMUNE">
                        <font <?php if ($tab_studente['NASCCOMUNE']=='') echo "color='red'";?>>
                        Luogo di nascita *
                        </font>
                    </label>
            ...
            <div class="row">
                <div class="col-lg-6 mb-2">
                    <label for="NAZIONE_NASCITA">
                        <font <?php if ($tab_studente['NASCNAZI']=='') echo "color='red'";?>>
                        Nazione nascita *
                        </font>
                    </label>
                    <div class="ui-widget">
                ...
                <div class="col-lg-6 mb-2">
                    <label for="PROVINCIA_NASCITA">
                        <font <?php if ($tab_studente['NASCNAZI']=='1' && $tab_studente['NASCPROV']=='') echo "color='red'";?>>
                        Provincia nascita *
                        </font>
                    </label>
                    <div class="ui-widget">
            ...
            <div class="row">
                <div class="col-lg-6 mb-2">
                    <label for="CITTADINANZA_NASCITA">
                        <font <?php if ($tab_studente_nascita['CITTADINANZA']=='') echo "color='red'";?>>
            ...
            <div class="row">
                <div class="col-lg-6 mb-2">
                    <label for="CITTADI2">
                        <font <?php if ($tab_studente['CITTADI2']=='') echo "color='red'";?>>
        ...
        <div class="col-lg-6 mb-2 mt-2">
            <div class="row">
                <div class="col-lg-9 mb-2">
                    <label for="CODFISCA">
                        <font <?php if ($tab_studente['CODFISCA']=='') echo "color='red'";?>>
                        Codice Fiscale *
                        </font>    
                    </label>
                ...
                <div class="col-lg-3 mb-2">
                    <label for="SESSO">
                        <font <?php if ($tab_studente['SESSO']=='') echo "color='red'";?>>
                        Sesso *
                        </font>
                    </label>
            ...
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <label for="STATOCIV">
                        <font <?php if ($tab_studente['STATOCIV']=='') echo "color='red'";?>>
                        Stato religioso *
                        </font>
                    </label>
            ...
            <div class="row" style="<?php echo $StyleOrdineDiocesi;?>">
                <div class="col-lg-12 mb-2">
                    <?php if (($OrdineDiocesi=="Ordine *" && $tab_studente['ORDINE']=='') || ($OrdineDiocesi=="Diocesi *" && $tab_studente['DIOCESI']=='')):?>
                    <input type="text" class="form-control-plaintext inputcolor" id="lblOrdineDiocesi" value="<?php echo $OrdineDiocesi; ?>" readonly/>
                    <?php else:?>
