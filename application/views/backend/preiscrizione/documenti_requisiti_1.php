        ...
        <?php endif;?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-2">
                    <select id="ITASTRANIERI" name="ITASTRANIERI" class="form-control">
                        <option value=''></option>
                    <?php
                        if ($tab_studente['ITASTRANIERI']==='S'){
...
<!--            <div class="row">
                <div class="col-lg-12 mb-2">
                    ...
                    <textarea class="form-control" rows="3" id="STATODOC_NOTA" name="STATODOC_NOTA" value=""><?php //if(isset($tab_studente['NOTA']))echo $tab_studente['NOTA'];?></textarea>
                </div> 
            </div>            -->
        <?php endif;?>
        </div>
<!--Pannello di destra-->        
        <div class="col-lg-6 mb-2 mt-2">
        <?php if (isset($tab_studente['PRIMALINGUA']) && $tab_studente['PRIMALINGUA']>0):?>
        <?php if ($tipo_utente=='segreteria'):?>
            <div class="row">
                <div class="col-lg-12 mb-2">
        ...
        <?php endif;?>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    ...
                    <label for="TITOLOSTUDIO_PDF">Titolo studio (o almeno degli esami già sostenuti) *</label>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 mb-2 mt-n2">
                    scadenza * 
                </div>
                <div class="col-lg-4 mb-2 mt-n2">
                    <!--<input type="text" class="form-control" id="datascad_permessosogg" name="datascad_permessosogg" value="<?php echo substr($tab_studente['datascad_permessosogg'],0,10);?>" placeholder="aaaa-mm-gg" onchange="Controlla_datascad_permessosogg()"/>-->
